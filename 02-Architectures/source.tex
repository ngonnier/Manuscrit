...
Cependant, peu de travaux ont exploré l'idée de les assembler en architecture comportant des rétroactions, formant ainsi un nouveau système d'apprentissage.
La deuxième approche motivant la création d'un tel système se place au niveau de l'apprentissage développemental.
...
Nous étudierons dans cette thèse un modèle de création d'architectures de cartes auto-organisatrices ou SOM (\emph{Self-Organizing Maps}) modulaires décentralisées.
