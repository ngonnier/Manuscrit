...
Nous pouvons citer comme exemple fonctionnel de traitement multisensoriel de l'information l'effet ventriloque \cite{Bonath2007NeuralBO}, qui correspond à l'illusion que la source sonore provient de la marionnette du ventriloque, dont la bouche s'agite de façon coordonnée aux paroles, alors qu'elle provient en réalité du ventriloque lui-même.
...
Après quelques millisecondes, on observe une activité auditive pour les neurones sensibles à l'emplacement spatial de la source du stimulus visuel \cite{lefort_apprentissage_2012}.
Un autre exemple est celui de l'effet McGurk~\cite{McGurk1976HearingLA}~: ces psychologues ont montré que la présentation du son \og ba \fg{} à un sujet associée à la présentation d'une vidéo d'une bouche prononçant \og ga \fg{} amènent le sujet à indiquer qu'il a entendu le son \og da \fg{}.
