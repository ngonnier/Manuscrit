...
Les travaux que nous présentons dans cette thèse explorent la création d'une architecture non hiérarchique de cartes auto-organisatrices (SOM).
...
% Ce modèle est également décliné en une version dynamique dans laquelle les paramètres des cartes dépendent des données présentées, en \cite{Costa2016ANS}.
