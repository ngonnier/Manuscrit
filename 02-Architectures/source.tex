...
Les cartes auto-organisatrices y ajoutent une topologie sur laquelle s'appuie cette représentation de l'espace d'entrée. Les prototypes $\w$ sont alors positionnés sur les n\oe{}uds d'un graphe, et indexés par une position $p$. Ce graphe se présente en général comme une grille de faible dimension, en général une grille 2D, définissant une correspondance directe entre la dimension de la carte et les positions $p$ des n\oe{}uds
...
Les valeurs d'activation que nous considérons pour le choix du BMU sont quant à elles $a(p)$, calculées à $\inpx$ fixé, tracées sur la figure par la courbe en rouge. Le Best Matching Unit est choisi comme l'argmax de cette activation.
