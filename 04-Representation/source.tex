...
Dans le chapitre précédent, nous avons proposé l'algorithme CxSOM, permettant de construire des architectures non-hiérarchiques modulaires de cartes auto-organisatrices. Dans ces architectures non-hiérarchiques, plusieurs cartes sont connectées. 
...
Nous étudierons l'architecture CxSOM dans un cadre particulier de mémoire associative.
...
Ces représentations ont pour but non seulement de qualifier la qualité de l'apprentissage, et surtout de mettre en lumière les propriétés et l'organisation des cartes émergeant de l'algorithme d'apprentissage.
La création de méthodes de représentation adaptées au modèle sur une architecture élémentaire de peu de cartes nous permet de poser les bases pour l'étude de plus grandes architectures par la suite.
