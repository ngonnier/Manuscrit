...
Pour analyser cet apprentissage associatif émergeant d'une architecture de cartes, nous avons besoin d'introduire de nouvelles représentations par rapport à celles utilisées pour l'étude des SOM classiques. 
Ce chapitre élabore des représentations que nous utiliserons dans les expériences présentées dans la suite de cette thèse.
