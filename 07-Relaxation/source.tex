...
% Cette partie présente des résultats sur deux exemples de configuration. Nous avons réalisé ces observations sur plusieurs configurations de poids et d'entrées, qui nous permettent d'être plus généraux sur les conclusions que nous présentons, mais cette étude reste empirique, nos conclusions étant donc des observations.
