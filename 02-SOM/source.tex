...
\centering
\includegraphics[width=0.45\textwidth]{activite_layers_2maps.pdf}
%\end{minipage}
...
\begin{figure}
\centering
\includegraphics[width=0.45\textwidth]{maj_2som.pdf}
%\end{minipage}
...
On choisit de prendre une valeur $h_{ci_k} = h_c$ commune à toutes les couches de poids contextuels d'une carte. Ainsi, on apporte une symétrie dans les connexions: les carte réagissent de la même façon aux autres cartes.
