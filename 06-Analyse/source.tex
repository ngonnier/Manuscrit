...
Nous étudierons dans ce chapitre des architectures de $N = 2$, puis $N=3$ cartes en une dimension.
L'étude en 1D facilite les représentations et permet donc une meilleure compréhension des mécanismes d'apprentissage.
