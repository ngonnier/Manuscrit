...
Le but de cette thèse est d'identifier les comportements d'auto-organisation de l'architecture CxSOM qui traduisent l'apprentissage d'une représentation du modèle d'entrée multimodal et des relations entre les entrées par l'architecture.
...
Nous avons choisi de nous intéresser d'abord aux comportements occurrant dans un modèle d'architecture non-hiérarchique de deux cartes, dans laquelle chaque carte prend en entrée le BMU de sa voisine.
