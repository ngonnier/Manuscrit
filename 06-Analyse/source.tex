...
Nous étudierons dans ce chapitre des architectures de $N = 2$, puis $N=3$ cartes en une dimension. L'étude en 1D facilite les représentations et permet donc une meilleure compréhension des mécanismes d'apprentissage.
...
Contrairement au cas précédents, les BMUs se répartissent sur toutes les valeurs de $\w_c$ dans une zone.	
	...
	\begin{figure}[H]
		\centering\includegraphics[width=0.9\textwidth]{lissa/weights_19999.pdf}
		\vspace{-0.5cm}
...
\begin{figure}[H]
	\centering\includegraphics[width=0.8\textwidth]{anneau/weights.pdf}
...
\begin{figure}[h!]
	\centering\includegraphics[width=0.4\textwidth]{ballard_primary_secondary.png}
