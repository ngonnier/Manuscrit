...
L'objectif de ce chapitre est de présenter comment les comportements d'organisation identifiés sur les cartes CxSOM en une dimension se généralisent à des cartes en deux dimensions.
...
Les expériences que nous présentons ici ne nécessitent pas d'adaptation spécifique de l'algorithme.
