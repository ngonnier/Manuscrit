...
\include{titlepage}
\tableofcontents
\include{00-Introduction/source}
\mainmatter
\include{01-Modularite/source}
\include{01bis-Architectures/source}
%Chapitre en plus : multimodalité ?
\include{02-SOM/source}
\include{03-Representation/source}
\include{03-Indicateur/source}
\include{04-Analyse/source}
\include{05-Application/source}
\include{Conclusion}
%Bibliography files
\bibliography{01-Modularite/biblio_modularite.bib,01-Modularite/biblio_reseaux.bib, 03-Representation/biblio_representation.bib,02-SOM/biblio_SOM.bib,publis.bib}
