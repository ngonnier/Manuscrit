...
%Citons par exemple le jeu de la Vie \cite{Gardener1970MathematicalGT}
% chen_modularity_2016 emergence et modularité.
% \cite{Siebert2020RoleOM} : auto-organisation et modularité sont liées.
